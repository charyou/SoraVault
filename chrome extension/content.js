...
(function () {
    ...
    // Source enable/disable state — opt-in sources may start disabled
    ...
    function buildTxtContent(item) {
        ...
        if (item.source === 'v1_uploads') {
            ...
            if (item.width && item.height) {
                lines.push(`Resolution     : ${item.width} Ã— ${item.height} px`);
                lines.push(`Aspect ratio   : ${item.ratio || '?'}`);
            }
            if (item.taskType) lines.push(`Type           : ${item.taskType}`);
            lines.push('', 'â”€â”€ Upload Notes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€', item.prompt || '(none)');
            return lines.join('\n');
        }
